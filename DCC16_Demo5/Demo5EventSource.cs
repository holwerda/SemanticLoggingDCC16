...
{
    [EventSource(Name = "DCC16-DCC16Demo5-Demo5EventSource")]
    public sealed class Demo5EventSource : EventSource
    {
        private static Lazy<Demo5EventSource> _log = new Lazy<Demo5EventSource>();

        public Demo5EventSource() { }

        public static Demo5EventSource Log
        {
